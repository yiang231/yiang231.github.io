<template>
  <div :style="'background: #f8f8f8;min-height: '+windowSize.height+'px'">
    ...
    <van-cell class="mobile-border mobile-margin-top" icon="sign" is-link title="　Github主页"
              url="https://github.com/yiang231"/>
    <van-cell class="mobile-border mobile-margin-top" icon="logistics" is-link title="　项目源码"
              url="https://github.com/yiang231/yiang231.github.io"/>
