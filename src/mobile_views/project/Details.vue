<template>
    <div>
        <van-nav-bar :title="project.name" left-arrow
            left-text="返回" right-text="分享" style="position:fixed;top:0;z-index: 9999; box-shadow: 0px -5px 10px #888888;width: 100%;" @click-left="$router.go(-1)" @click-right="$mobileShare()"/>
