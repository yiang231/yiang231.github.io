<template>
    <div :style="'background: #f8f8f8;min-height: '+windowSize.height+'px'">
        <van-nav-bar right-text="分享" style="position:fixed;top:0;z-index: 9999; box-shadow: 0px -3px 10px #888888;width: 100%;" title="开源项目"
            @click-right="$mobileShare()" />
        <div style="height: 60px;"></div>
        <router-link v-for="(item,index) in projects" :key="'p'+index" :to="`/mobile/user/project/details/${item.name}`" style=" text-decoration:none;cursor:pointer">
