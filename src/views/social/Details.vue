    ...
    <div v-loading="loading">
        <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;">
            <div slot="header" class="clearfix">
                ...
                <el-button icon="el-icon-d-arrow-left" style="float: right; padding: 3px 0" type="text" @click="$router.go(-1)">返回</el-button>
            </div>
            <el-row>
                <el-col :span="9" style="padding: 0px 10px 20px 0px">
                    ...
                    <div style="padding: 10px">
                        ...
                        <font v-if="location" style="font-size: 14px;line-height: 20px;color:#606266;">
                            <i class="el-icon-location-outline"></i>&nbsp;&nbsp;{{location}}
                            <br>
                        </font>
                        <font v-if="email" style="font-size: 14px;line-height: 20px;color:#606266;">
                            <i class="el-icon-message"></i>&nbsp;&nbsp;{{email}}
                            <br>
                        </font>
                        <font v-if="blog" style="font-size: 14px;color:#606266;">
